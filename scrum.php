      ...
      <div class="flex items-center w-[100%] justify-between ">
        ...
        <div class="hidden sm:block sm:ml-6 w-1/">
          <div class="flex space-x-4 ml-50 ">
            <form action="scrum.php" method="post" class="flex w-[100%]">
  ...
  <div class="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm flex items-center space-x-3 hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
    ...
    <div class="flex-1 min-w-0">
      <a href="#" class="focus:outline-none">
        ...
        <p class="text-sm text-gray-500 truncate">member</p>
      </a>
    </div>
  </div>
</div>
            ...
            <tr>
                <th scope="col" class="px-4 py-3">
                   <?php if(isset($_POST['projects'])){
                    echo " teams"; }elseif(isset($_POST['teams'])){
                        echo " Projects ";
                ...
                <th scope="col" class="px-4 py-3">
                <?php if(isset($_POST['projects'])){
                    echo "team status"; }elseif(isset($_POST['teams'])){
                        echo "Project status ";
                    }elseif(isset($_POST['members'])){
                        echo "Member Status";
                } ?>
                ...
                <th scope="col" class="px-4 py-3">
                <?php if(isset($_POST['projects'])){
                    echo "Project Name"; }elseif(isset($_POST['teams'])){
                        echo "Team Name ";
                    }elseif(isset($_POST['members'])){
                            echo "Member Team";
                    } ?>
